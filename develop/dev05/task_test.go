...
func TestGrep(t *testing.T) {
	testtable := []struct {
		...
		{testconf: ConfigGrep{inputfile: "test1", pattern: "name", line: true}, testname: "grep -n name test1", out: "1 my name is noname\n", iserror: false, messageerror: ""},
		{testconf: ConfigGrep{inputfile: "test1", line: true}, testname: "grep -n test1", out: "0 li st symbols\n1 my name is noname\n2 my work is programmer\n3 i am programmer\n", iserror: false, messageerror: ""},
